package com.oc.kafka.wechat.controller;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.google.common.collect.Maps;

import com.oc.kafka.wechat.common.BaseResponseVO;
...
public class WechatTemplateController {
    ...
    @Autowired
    private WebchatTemplateProperties properties;
    ...
    public BaseResponseVO getTemplate(){
        ...
        WechatTemplate wechatTemplate = wechatTemplateService.getWechatTemplate();
